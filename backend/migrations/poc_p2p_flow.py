...
async def main() -> int:
    ...
    async with httpx.AsyncClient() as client:
        ...
        print(f"[PASS] US3: PO remaining = 620 across 3 items")
        ...
        print(f"[PASS] US5: GR1 received partially")
        ...
        print(f"[PASS] US6: PO status=partially_received, qty_received synced")
        ...
        print(f"[PASS] US7: rahaza_material_stock reflects GR1")
        ...
        print(f"[PASS] US8: GR2 expected_qty correctly = remaining qty")
        ...
        print(f"[PASS] US9: Over-receive correctly rejected")
        ...
        print(f"[PASS] US10: GR2 received normally")
        ...
        print(f"[PASS] US11: PO status=fully_received")
        ...
        print(f"[PASS] US12: Cannot create GR from fully_received PO")
        ...
        print(f"[PASS] US13: PO/grs audit trail returns 2 GRs")

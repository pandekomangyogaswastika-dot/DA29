...
async def main():
    ...
    async with httpx.AsyncClient() as client:
        ...
        print(f"[PASS] US1.b: rahaza_materials.type='accessory'")
        ...
        print(f"[PASS] US1.c: no legacy acc_items doc")
        ...
        assert len(our) == 1, f"US4 FAILED: item not in stock list"
        ...
        print(f"[PASS] US4: /api/acc/stock shows saldo=7")

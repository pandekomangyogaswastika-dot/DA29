...
def build_monthly_report_pdf(report_data: dict, company_name: str = 'CV. Dewi Aditya') -> bytes:
    ...
    # ── HEADER ────────────────────────────────────────────────────────────────
    elements.append(Paragraph(f"LAPORAN BULANAN MARKETING", S['title']))
    ...
    for i, row in enumerate(accounts, start=1):
        ...
        if rev_c: tbl_style.append(('BACKGROUND', (4, i), (4, i), rev_c))
        if ord_c: tbl_style.append(('BACKGROUND', (7, i), (7, i), ord_c))
...
def build_creator_target_pdf(summary_data: dict, company_name: str = 'CV. Dewi Aditya') -> bytes:
    ...
    for i, row in enumerate(creators, start=1):
        ...
        if rc: tbl_style.append(('BACKGROUND', (4, i), (4, i), rc))
        if sc: tbl_style.append(('BACKGROUND', (7, i), (7, i), sc))

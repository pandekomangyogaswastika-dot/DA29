...
class PhaseCTester:
    ...
    def test_removed_get_orders_list(self) -> bool:
        ...
        if success:
            self.log(f"   ✓ Endpoint correctly removed (404)")
            return True
        # If we got 200, that means endpoint still exists
        if not success and self.errors[-1]['actual'] == 200:
            self.log(f"   ❌ Endpoint still exists! Should be removed.", "FAIL")
        return False
    ...
    def test_get_migrated_pos(self) -> bool:
        ...
        if success and isinstance(response, list):
            ...
            if len(migrated) >= 3:
                self.log(f"   ✓ MKLO-LEG-001/002/003 exist")
                return True
            else:
                self.log(f"   ⚠ Expected at least 3 migrated POs", "WARN")
        return False
    ...
    def test_retained_put_orders_status(self) -> bool:
        ...
        if success:
            self.log(f"   ✓ Retained endpoint works (status update)")
            return True
        return False
    ...
    def test_retained_put_orders_stage_qty(self) -> bool:
        ...
        if success:
            self.log(f"   ✓ Retained endpoint works (stage qty update)")
            return True
        return False
    ...
    def test_retained_get_orders_production_detail(self) -> bool:
        ...
        if success:
            ...
            self.log(f"   ✓ Retained endpoint works (production detail)")
            return True
        return False
    ...
    def test_retained_get_orders_material_issues(self) -> bool:
        ...
        if success:
            ...
            self.log(f"   ✓ Retained endpoint works (material issues list)")
            return True
        return False
    ...
    def test_ssot_create_po(self) -> bool:
        ...
        if success and 'id' in response:
            ...
            self.log(f"   ✓ SSOT endpoint works (PO creation)")
            return True
        return False
    ...
    def test_ssot_confirm_po(self) -> bool:
        ...
        if success:
            ...
            self.log(f"   ✓ SSOT endpoint works (PO confirmation)")
            return True
        return False
    ...
    def test_ssot_cancel_po(self) -> bool:
        ...
        if success:
            ...
            self.log(f"   ✓ SSOT endpoint works (PO cancellation)")
            return True
        return False
    ...
    def test_openapi_endpoint_count(self) -> bool:
        ...
        if success and isinstance(response, dict):
            ...
            if len(maklon_orders_endpoints) == 6:
                self.log(f"   ✓ Exactly 6 endpoints retained (as expected)")
                return True
            else:
    ...
    def test_clients_endpoint(self) -> bool:
        ...
        if success and isinstance(response, list):
            ...
            self.log(f"   ✓ Clients endpoint untouched")
            return True
        return False

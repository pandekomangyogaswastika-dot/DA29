...
class TokoBackendTester:
    ...
    def run_all_tests(self):
        ...
        try:
            ...
            self.log(f"✓ Order status updated to 'packed' with packed_date set")
        except AssertionError as e:
            self.log(f"❌ {e}", "FAIL")
            return False
        ...
        try:
            ...
            self.log(f"✓ Order status updated to 'shipped' with tracking_number")
        except AssertionError as e:
            self.log(f"❌ {e}", "FAIL")
            return False
        ...
        try:
            ...
            self.log(f"✓ Return decision updated to 'refund'")
        except AssertionError as e:
            self.log(f"❌ {e}", "FAIL")
            return False
        ...
        try:
            ...
            self.log(f"✓ Review responded with status 'responded'")
        except AssertionError as e:
            self.log(f"❌ {e}", "FAIL")
            return False
        ...
        try:
            ...
            self.log(f"✓ Stock received and recorded in rahaza_material_stock")
        except AssertionError as e:
            self.log(f"❌ {e}", "FAIL")
            return False
        ...
        try:
            ...
            self.log(f"✓ Movement recorded in rahaza_material_movements")
        except AssertionError as e:
            self.log(f"❌ {e}", "FAIL")
            return False
        ...
        try:
            ...
            self.log(f"✓ Stock issued and decreased to 7.0")
        except AssertionError as e:
            self.log(f"❌ {e}", "FAIL")
            return False

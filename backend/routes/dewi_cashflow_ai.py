...
async def _build_context(db) -> dict:
    ...
    for inv in ar_invs:
        ...
        try:
            ...
            diff = 0
        if diff <= 0:     ar_buckets['current'] += bal
        elif diff <= 30:  ar_buckets['1-30'] += bal
        elif diff <= 60:  ar_buckets['31-60'] += bal
        elif diff <= 90:  ar_buckets['61-90'] += bal
        else:             ar_buckets['90+'] += bal
    ...
    for inv in ap_invs:
        ...
        try:
            ...
            diff = 0
        if diff <= 0:     ap_buckets['current'] += bal
        elif diff <= 30:  ap_buckets['1-30'] += bal
        elif diff <= 60:  ap_buckets['31-60'] += bal
        elif diff <= 90:  ap_buckets['61-90'] += bal
        else:             ap_buckets['90+'] += bal

...
async def check_expiring_contracts(db, settings: Optional[dict] = None) -> list:
    ...
    alerts = []
    thresholds = [
        (1,  "error",   "Kontrak berakhir HARI INI"),
        (7,  "error",   "Kontrak berakhir dalam 7 hari"),
        (14, "warning", "Kontrak berakhir dalam 14 hari"),
        (30, "warning", "Kontrak berakhir dalam 30 hari"),
    ]

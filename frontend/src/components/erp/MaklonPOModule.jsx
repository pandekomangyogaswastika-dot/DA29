...
// ─── MAIN MODULE ──────────────────────────────────────────────────────────────
export default function MaklonPOModule({ token }) {
      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" onClick={() => setCreateDialog(true)} className="bg-violet-600 hover:bg-violet-500">
      ...
      <GlassCard className="p-4 space-y-4">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-40 text-slate-500 gap-2">
            ...
            <Button size="sm" onClick={() => setCreateDialog(true)} className="bg-violet-600 hover:bg-violet-500 mt-2">

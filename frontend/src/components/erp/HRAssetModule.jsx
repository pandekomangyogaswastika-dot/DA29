                ...
                {assets.length === 0 && (
                  <tr>
                    <td colSpan={7} className="text-center py-12 text-muted-foreground">
                      ...
                      <Button size="sm" className="mt-3" onClick={() => setAssetDialog({})}>
                        Tambah Aset Pertama
                      </Button>
                    </td>
                  </tr>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-white/5">
                ...
                {assignments.length === 0 && (
                  <tr><td colSpan={6} className="text-center py-8 text-muted-foreground">Tidak ada penugasan aktif</td></tr>
                )}
              </tbody>
            </table>
          </div>
            ...
            <div className="md:col-span-2 space-y-3">
              {selectedEmp ? (
                <>
                  ...
                  {empAssets.length > 0 ? (
                    ...
                    <div className="text-center py-10 text-muted-foreground">
                      ...
                      <p className="text-sm">Tidak ada aset yang dipinjam</p>
                    </div>
                  )}
                </>
              ) : (
                <div className="text-center py-16 text-muted-foreground">
                  ...
                  <p>Pilih karyawan untuk melihat aset yang dipinjam</p>
                </div>
              )}
            </div>
          </div>

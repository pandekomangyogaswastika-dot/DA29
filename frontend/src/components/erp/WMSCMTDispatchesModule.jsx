  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-800 text-zinc-100" data-testid="wms-cmt-dispatches-module">
      ...
      <div className="flex-1 overflow-auto p-6">
        {loading ? (
          <div className="flex items-center justify-center h-64" data-testid="loading-dispatches">
            <Loader2 className="w-8 h-8 animate-spin text-blue-400" />
          </div>
        ) : filteredDispatches.length === 0 ? (
          <div className="text-center py-16" data-testid="empty-dispatches">
            <Truck className="w-16 h-16 mx-auto text-zinc-700 mb-4" />
            <p className="text-zinc-500">Belum ada CMT dispatch</p>
          </div>
        ) : (

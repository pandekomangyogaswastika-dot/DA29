...
import {
  Settings, Sparkles, Landmark, UserX, MapPin, Database, RefreshCw,
      ...
      <div className="rounded-xl border border-white/10 bg-white/5 overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-white/5">
            ...
            {grades.length === 0 && <tr><td colSpan={6} className="text-center py-8 text-muted-foreground">Belum ada grade</td></tr>}
          </tbody>
        </table>
      </div>
